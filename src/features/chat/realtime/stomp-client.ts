...
export const CHAT_STOMP_ROOM_SUB_PREFIX =
  process.env.NEXT_PUBLIC_CHAT_STOMP_ROOM_SUB_PREFIX || DEFAULT_ROOM_SUB_PREFIX
...
export const CHAT_STOMP_READ_RECEIPT_DEST =
  process.env.NEXT_PUBLIC_CHAT_STOMP_READ_RECEIPT_DEST ||
  DEFAULT_READ_RECEIPT_DEST
